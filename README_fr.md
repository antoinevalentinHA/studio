...
- Cinq sessions documentées d'opérations sur appareil réel, sur deux appareils — voir
  `FIELD-VALIDATION.md`.
...
- Les résultats de terrain proviennent de cinq sessions, une machine, deux appareils. Ils ne se
